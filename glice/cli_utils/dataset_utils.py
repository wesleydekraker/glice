...
from ..data import GraphDataset, JoernDataset
...
def get_dataset(dataset_cls: Optional[Type[GraphDataset]], split_index: int, data_dir: str, vocab_dir: str,
    ...
    if not dataset_cls:
        ...
        if len(dataset_default_hyperparameter_overrides):
            print(f"  Dataset parameters overridden by task/model defaults: "
    ...
    return JoernDataset(split_index, data_dir, vocab_dir, dataset_params, loaded_metadata)
